...
class lanhe_fapiao:
    ...
    def flow1(self):
        ...
        while 1:
            ...
            c_ode = iocr.vcode_recognize(image_path=tvar2314544729489,code_type=8001,apiKey='8159a500cc9d4a69a71e6ac14263f029',secretKey='2d078aa8c13741239b3d00ced85832e3')
            time.sleep(1)
            # 鼠标点击
            ...
            time.sleep(0.5)
            ikeyboard.key_send_cs(text=c_ode,waitfor=10)
            # 鼠标点击
