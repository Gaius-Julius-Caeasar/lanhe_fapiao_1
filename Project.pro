            ...
            "spv": [
                {
                    ...
                    "inpar_required": "0",
                    "inputpar": "",
                    "vardef": "[dict['InvoiceType'],dict['InvoiceTypeOrg'],dict['PurchaserRegisterNum'],dict[ 'InvoiceDate'],dict[ 'InvoiceCode'],dict['InvoiceNum'],dict['CheckCode'],dict['TotalAmount'],dict['TotalTax'],dict[ 'AmountInFiguers'],dict[ 'CommodityName']]",
                    "vardesc": "",
                    "varname": "lv_5",
                    "varpasstype": "1",
                    "varrobot": "",
